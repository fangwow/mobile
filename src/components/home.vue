    ...
    <div class="main">
        ...
        <ul class="mui-table-view mui-grid-view mui-grid-9">
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    ...
                    <div class="mui-media-body">超级划算</div></a>
            </li>
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    <img src="../assets/image/menu2.png" alt="">
                    <div class="mui-media-body">9.9包邮</div></a>
            </li>
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    <img src="../assets/image/menu3.png" alt="">
                    <div class="mui-media-body">高额券</div></a>
            </li>
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    <img src="../assets/image/menu4.png" alt="">
                    <div class="mui-media-body">淘宝</div></a>
            </li>
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    <img src="../assets/image/menu5.png" alt="">
                    <div class="mui-media-body">天猫</div></a>
            </li>
            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"><a href="#">
                    <img src="../assets/image/menu6.png" alt="">
                    <div class="mui-media-body">拼多多</div></a>
            </li>
        </ul> 
    </div>
</template>
